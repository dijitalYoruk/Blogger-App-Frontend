<template>
    <div v-if="showComponent" class="row mt-5">
        <div class="col-12">
                        ...
                        <div class="col-10">
                            <div class="row border-bottom">
                                ...
                                <div class="col-auto ml-auto">
                                    ...
                                    >Follow</button>
                                    <button
                                        v-if="showUnfollowButton(user.id)"
...
export default {
    ...
    methods: {
        retrieveUsers(page) {
            ...
            this.$store.dispatch("retrieveFollowers", { page, id });
        },
        clearUsers() {
        ...
        unfollowUser(user_id, index) {
            this.$store
                ...
                .then(response => {
                    this.$store.commit("deleteFollowing", index);
                })
                .catch(error => {
                    this.$toastr.e(error);
                });
        ...
        showFollowButton(id) {
            return (
                !this.followers.some(obj => obj.id == id) &&
                !this.isCurrentUser(id)
            );
        },
        showUnfollowButton(id) {
            return (
                this.followers.some(obj => obj.id == id) &&
                !this.isCurrentUser(id)
            );
        ...
        isCurrentUser(id) {
            return this.$store.getters.getCurrentUser.id == id;
        }
    },
    computed: {
        users() {
